...
<php lang="en">
<head>
<title>0 EDUGUARD - Contact</title>
<meta charset="utf-8">
	...
	<div class="contact">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="about">
						<div class="about_title">GET REGISTERED</div>
						<p class="about_text">get your self registered for safe future with dedicated mentorship and guidance and be up to date with the latest educational news and updates.</p>
